...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const emailVal = formData.get('email')?.toString().trim() || email;
    const passwordVal = formData.get('password')?.toString() || password;
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-xl py-3 bg-gray-50 transition-colors hover:bg-white"
